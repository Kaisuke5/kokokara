	...
	<div class="row">
	  ...
	  <div class="col-md-12">
		  ...
		  <div class="col-md-3 col-xs-6 col-gal">
		  	<div style="height:190px; background:#d16b9a;"></div>	
		  </div>
		  <div class="col-md-3 col-xs-6 col-gal">  
		  	<div style="height:190px; background:#d1a16b;"></div>		
		  </div>
		  <div class="col-md-3 col-xs-6 col-gal">
		  	<div style="height:190px; background:#ced16b;"></div>	  	
		  </div>
		  <div class="col-md-3 col-xs-6 col-gal">
		  	<div style="height:190px; background:#9ad16b;"></div>	  	
		  </div>
		  <div class="col-md-3 col-xs-6 col-gal">  	
		  	<div style="height:190px; background:#6bd16e;"></div>	 
		  </div>
		  <div class="col-md-3 col-xs-6 col-gal">  
		  	<div style="height:190px; background:#6bd1a1;"></div>		
		  </div>
		  <div class="col-md-3 col-xs-6 col-gal">  
		  	<div style="height:190px; background:#6bcad1;"></div>		
		  </div>
		  <div class="col-md-3 col-xs-6 col-gal">  	
		  	<div style="height:190px; background:#6bcad1;"></div>
		  </div>
